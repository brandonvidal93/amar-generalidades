...
class Content extends Component {
  showContent = () => {
    ...
    switch (actualIndex) {
      ...
      case 7:
        return (
          <Page7 dataPage = { data.page7 } endActivities = { endActivities[7] } checkEndActivity = { checkEndActivity } />
        );
      case 8:
        return (
          <Page8 dataPage = { data.page8 } endActivities = { endActivities[8] } checkEndActivity = { checkEndActivity } />
        );
      case 9:
        return (
          <Page9 dataPage = { data.page9 } endActivities = { endActivities[9] } checkEndActivity = { checkEndActivity } />
        );
      case 10:
        return (
          <Page10 dataPage = { data.page10 } endActivities = { endActivities[10] } checkEndActivity = { checkEndActivity } checkEnabledUnit = { checkEnabledUnit } checkEndUnit = { checkEndUnit } />
        );
      // FIN UNIDAD 1 ---------------------------------------------------------------------------
      ...
      case 13:
        return (
          <Page13 dataPage = { data.page13 } endActivities = { endActivities[13] } checkEndActivity = { checkEndActivity } checkEnabledUnit = { checkEnabledUnit } checkEndUnit = { checkEndUnit } />
        );
      // FIN UNIDAD 2 ---------------------------------------------------------------------------
      ...
      case 15:
        return (
          <Page15 dataPage = { data.page15 } endActivities = { endActivities[15] } checkEndActivity = { checkEndActivity } />
        );
      case 16:
        return (
          <Page16 dataPage = { data.page16 } endActivities = { endActivities[16] } checkEndActivity = { checkEndActivity } />
        );
      case 17:
        return (
      ...
      case 20:
        return (
          <Page20 dataPage = { data.page20 } endActivities = { endActivities[20] } checkEndActivity = { checkEndActivity } checkEnabledUnit = { checkEnabledUnit } checkEndUnit = { checkEndUnit } />
        );
      // FIN UNIDAD 3 ---------------------------------------------------------------------------
      ...
      case 23:
        return (
          <Page23 dataPage = { data.page23 } endActivities = { endActivities[23] } checkEndActivity = { checkEndActivity } />
        );
      case 24:
        return (
      ...
      case 28:
        return (
          <Page28 dataPage = { data.page28 } endActivities = { endActivities[28] } checkEndActivity = { checkEndActivity } />
        );
      case 29:
        return (
          <Page29 dataPage = { data.page29 } endActivities = { endActivities[29] } checkEndActivity = { checkEndActivity } />
        );
      case 30:
        return (

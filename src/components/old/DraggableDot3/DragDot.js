...
const DragWord = ({ name, type, id, countWords, colorBg, posY, posX }) => {
  ...
  return (
    <div className = { 'dragWord d-Flex j-C aI-C pAbs'} ref = { drag } style = {{ ...style, 'opacity': opacity, 'backgroundColor': colorBg, 'top': posY, 'left': posX }} id = {'dragWord-' + id } onDragEnd = { countWords } >
